 ...
 * @LastEditTime: 2024-08-11 00:13:36
...
module.exports = {
  ...
  rules: {
    ...
    // 对自定义事件命名方式的要求
    'vue/custom-event-name-casing': 'on',
    ...
    // Vue 相关的规则设置
    'vue/attributes-order': 'on', // 属性顺序要求
    'vue/one-component-per-file': 'on', // 每个文件一个组件的限制
    'vue/html-closing-bracket-newline': 'off', // 关闭 HTML 闭合标签换行的要求
    'vue/max-attributes-per-line': 'off', // 关闭每行最大属性数的限制
    'vue/multiline-html-element-content-newline': 'on', // 关闭多行 HTML 元素内容换行要求
